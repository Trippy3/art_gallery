...
test.describe('Artwork Detail Page', () => {
  ...
  test.describe('Header and Navigation', () => {
    ...
    test('should navigate back to gallery on button click', async ({ page }) => {
      const backButton = page.locator('text=ギャラリーに戻る')
  ...
  test.describe('Specifications Section', () => {
    ...
    test('should display production year', async ({ page }) => {
      ...
      const yearValue = page.locator('text=制作年').locator('..').locator('p.text-foreground')
      await expect(yearValue).toBeVisible()
    })

    test('should display medium', async ({ page }) => {
      const mediumLabel = page.locator('text=メディウム')
    ...
    test('should display correct specifications for artwork 1', async ({ page }) => {
      const artwork = artworkData[0]
  ...
  test.describe('Tags Section', () => {
    ...
    test('should display all tags for artwork 1', async ({ page }) => {
      ...
      for (const tag of artwork.tags) {
        const tagElement = page.locator(`.rounded-full:has-text("${tag}")`).first()
        await expect(tagElement).toBeVisible()
      }
    })

    test('should display 3 tags for artwork 1', async ({ page }) => {
      const tags = page.locator('.bg-secondary.text-secondary-foreground.rounded-full')
    ...
    test('should have proper tag styling', async ({ page }) => {
      const tag = page.locator('.bg-secondary.text-secondary-foreground.rounded-full').first()
  ...
  test.describe('Data Validation', () => {
    ...
    test('should display correct tags count for each artwork', async ({ page }) => {
  ...
  test.describe('Content Integrity', () => {
    ...
    test('should have all required sections', async ({ page }) => {
      // Year badge
      await expect(page.locator('.rounded-full.bg-accent').first()).toBeVisible()
    ...
    test('should display all Japanese content', async ({ page }) => {
      ...
      await expect(page.locator('text=メディウム')).toBeVisible()
